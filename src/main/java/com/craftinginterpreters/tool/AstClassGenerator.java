...
public class AstClassGenerator {
    ...
    private static void defineAst(String out, String baseName, List<String> subNames) throws IOException {
        String path = out + "/" + baseName + ".java";
        ...
        defineVisitor(writer, baseName, subNames);

        for (String type : subNames) {
    ...
    private static void defineType(PrintWriter writer, String baseName, String typeName, String fields) {
        ...
        // Constructor...
        writer.println("        " + typeName + "(" + fields + ") {");
